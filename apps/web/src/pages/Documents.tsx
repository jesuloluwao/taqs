...
export default function Documents() {
  return (
    <div className="max-w-4xl mx-auto animate-fade-in">
      <div className="mb-6">
        <h1 className="text-heading-xl font-display text-neutral-900">Documents</h1>
        <p className="text-body-sm text-neutral-500 mt-0.5">
          Store and manage your tax documents
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-border shadow-soft overflow-hidden">
        <div className="flex flex-col items-center justify-center py-16 px-4 text-center animate-slide-up">
          ...
          <p className="text-heading-md text-neutral-900 mb-1">No documents yet</p>
          <p className="text-body-sm text-neutral-500 mb-5 max-w-xs">
            Upload bank statements, receipts, and tax documents to keep everything organised in one place.
          </p>
