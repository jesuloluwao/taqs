    ...
    <div className="max-w-4xl mx-auto animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-body-sm text-neutral-500 mt-0.5">
          File your self-assessment returns with FIRS
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-border shadow-soft overflow-hidden">
        <div className="flex flex-col items-center justify-center py-16 px-4 text-center animate-slide-up">
          <div className="w-16 h-16 rounded-2xl bg-primary-light flex items-center justify-center mb-4">
            <FolderOpen className="w-8 h-8 text-primary" strokeWidth={1.5} />
          </div>
          <p className="text-heading-md text-neutral-900 mb-1">No returns filed yet</p>
          <p className="text-body-sm text-neutral-500 mb-5 max-w-xs">
            Generate and submit your self-assessment tax return to FIRS. Nil returns are required by March 31.
          </p>
